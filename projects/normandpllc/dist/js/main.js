...
var FrontPageAnimationsModule = function () {
  ...
  function init() {
    ...
    if (window.innerWidth <= 992) {
      var menuButton = document.querySelector('.button-collapse');
...
$(document).ready(function () {
  ...
  $submitbtn.addEventListener('click', function () {
    ...
    var formLoaderTl = new TimelineMax();
    var formFbSplitText = new SplitText(".form-fb-span-submitted", { type: "words,chars" });
    var formFbSplitTextTl = new TimelineMax({ repeat: -1, repeatDelay: 0.25, smoothChildTiming: true });
    TweenLite.set(".form-fb-span-submitted", { perspective: 400 });
    formLoaderTl.fromTo('#FormLoader', .25, { force3D: true, yPercent: -100 }, { yPercent: 0, opacity: 1, zIndex: 1, ease: Circ.easeOut }).to('.form-progress', .25, { delay: 1, opacity: 0, ease: Circ.easeOut }).to('.form-fb-span', .25, { opacity: 0, ease: Circ.easeOut }).to('.form-fb-span-submitted', .25, { opacity: 1, ease: Circ.easeOut }, 'end').to($submitbtn, .25, { opacity: 0, ease: Circ.easeOut }, 'end');
